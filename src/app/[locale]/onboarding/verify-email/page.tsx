...
import { customerEmailVerificationTourSteps } from "@/config/tour-steps";
...
const VerifyEmailPage = () => {
  ...
  useEffect(() => {
    ...
    const storageKey = "onboarding-customer-email-tour-seen";
    const hasSeenTour = window.localStorage.getItem(storageKey);

    if (!hasSeenTour) {
      startTour(customerEmailVerificationTourSteps);
